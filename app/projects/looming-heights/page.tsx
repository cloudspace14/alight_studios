...
export default function LoomingHeightsPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] px-6 py-12 text-white">
      <div className="mx-auto flex max-w-3xl flex-col gap-10">
        ...
        <section className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm md:p-12">
          ...
          <h1 className="mb-5 text-4xl font-bold md:text-6xl">Looming Heights</h1>
          <p className="mb-8 text-lg leading-8 text-white/65">A 2D mobile platformer game and the first game developed by Alight Studios. Solve levels set in the sky and climb higher with every challenge.</p>
          ...
          <a href="https://mediafire.com/file/fdnck4hodlrzt5d/Looming+Heights_1.0.0.apk/file" target="_blank" rel="noreferrer"><LiquidButton size="xl" className="text-white border border-white/20 rounded-full"><Download className="h-4 w-4" /> Download APK</LiquidButton></a>
        </section>
      </div>
    </main>
  )
